        ...
        <div className="contenedor-principal container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav">
              <a className="nav-link menu1" href="/#">
                About
              </a>
              <a className="nav-link menu2" href="/#">
                Members
              </a>
              <a className="nav-link menu3" href="/#">
                Trainers
              </a>
              <a className="nav-link menu4" href="/#">
                FAQ
              </a>
              <a className="nav-link menu5" href="/#">
                Contact
              </a>
            </div>
          </div>
